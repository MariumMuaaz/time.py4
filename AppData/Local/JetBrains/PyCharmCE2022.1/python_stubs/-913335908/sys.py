...
class __loader__(object):
    ...
    _ORIGIN = 'built-in'
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_frozen_importlib', '__doc__': 'Meta path import for built-in modules.\\n\\n    All methods are either class or static methods to avoid the need to\\n    instantiate the class.\\n\\n    ', '_ORIGIN': 'built-in', 'module_repr': <staticmethod(<function BuiltinImporter.module_repr at 0x0000021E92E32320>)>, 'find_spec': <classmethod(<function BuiltinImporter.find_spec at 0x0000021E92E323B0>)>, 'find_module': <classmethod(<function BuiltinImporter.find_module at 0x0000021E92E32440>)>, 'create_module': <staticmethod(<function BuiltinImporter.create_module at 0x0000021E92E324D0>)>, 'exec_module': <staticmethod(<function BuiltinImporter.exec_module at 0x0000021E92E32560>)>, 'get_code': <classmethod(<function BuiltinImporter.get_code at 0x0000021E92E32680>)>, 'get_source': <classmethod(<function BuiltinImporter.get_source at 0x0000021E92E327A0>)>, 'is_package': <classmethod(<function BuiltinImporter.is_package at 0x0000021E92E328C0>)>, 'load_module': <classmethod(<function _load_module_shim at 0x0000021E92E317E0>)>, '__dict__': <attribute '__dict__' of 'BuiltinImporter' objects>, '__weakref__': <attribute '__weakref__' of 'BuiltinImporter' objects>})"
...
meta_path = [
    None, # (!) real value is '<_distutils_hack.DistutilsMetaFinder object at 0x0000021E9334D4E0>'
    __loader__,
    None, # (!) real value is "<class '_frozen_importlib.FrozenImporter'>"
    None, # (!) real value is "<class '_frozen_importlib_external.PathFinder'>"
    None, # (!) real value is '<six._SixMetaPathImporter object at 0x0000021E94098DC0>'
]
...
orig_argv = [
    ...
    '-c',
    'from multiprocessing.spawn import spawn_main; spawn_main(parent_pid=6892, pipe_handle=388)',
    '--multiprocessing-fork',
]

path = [
    'C:\\BuildAgent\\work\\1e7684eac3cc9a10\\community\\python\\helpers',
    'C:\\BuildAgent\\work\\1e7684eac3cc9a10\\community\\python\\helpers\\generator3',
    'C:\\BuildAgent\\work\\1e7684eac3cc9a10\\community\\python\\helpers',
...
path_hooks = [
    ...
    None, # (!) real value is '<function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0x0000021E92E33B50>'
]
...
stdlib_module_names = None # (!) real value is "frozenset({'_random', 'pstats', 'gc', '_pickle', 'weakref', 'dbm', 'mimetypes', 'pdb', '_collections', 'cgi', 'ctypes', 'dis', 'string', '_dbm', 'operator', 'wsgiref', 'keyword', '_pydecimal', 'errno', 'imaplib', 'mailcap', 'math', 'nt', 'pydoc', '_codecs_kr', '_sha512', '_signal', '_stat', 'enum', 'itertools', 'plistlib', 'shlex', 'sunau', 'shelve', 'rlcompleter', 'argparse', 'dataclasses', 'sysconfig', 'crypt', 'sre_constants', 'multiprocessing', '_io', 'asynchat', 'pathlib', 'queue', '_codecs', '_lzma', '_overlapped', 'subprocess', 'imp', 'quopri', '_sitebuiltins', '_codecs_cn', '_decimal', 'binascii', 'runpy', 'this', 'contextvars', 'genericpath', 'pyexpat', '_collections_abc', 'unicodedata', '_hashlib', 'xdrlib', 'xmlrpc', 'antigravity', '_osx_support', 'importlib', 'marshal', 'collections', 'timeit', 'bisect', 'functools', 'spwd', '_weakref', '_threading_local', '_elementtree', 'gettext', 'idlelib', 'winsound', 'ossaudiodev', 'zoneinfo', 'sqlite3', 'grp', '_warnings', 'http', 'imghdr', '_multiprocessing', 'symtable', '_sha3', 'aifc', 'difflib', '_lsprof', 'html', 'ssl', 'lib2to3', 'telnetlib', '_statistics', 'hmac', '_sre', 'warnings', 'lzma', '_codecs_jp', 'stat', 'xml', 'time', 'calendar', 'distutils', '_struct', '_zoneinfo', 'ftplib', 'linecache', 'pwd', 'site', 'uuid', 'textwrap', 'copy', 'zipapp', '_codecs_tw', 'profile', 'sys', 'ast', '_weakrefset', 'base64', 'select', 'sre_parse', 'tkinter', 'cgitb', '_imp', '_socket', 'doctest', 'wave', 'netrc', 'tracemalloc', '_curses_panel', '_frozen_importlib_external', '_pyio', 'tarfile', 'stringprep', 'json', 'zipfile', 'abc', '_string', 'io', '_heapq', '_ctypes', 'binhex', '_ast', 'pickletools', '_py_abc', 'poplib', 'nntplib', 'uu', 'webbrowser', 'struct', 'pickle', '_thread', 'pkgutil', 'datetime', 'builtins', '_posixsubprocess', '_sha1', 'concurrent', 'locale', 'configparser', 'fcntl', 'pipes', 'encodings', 'trace', 'selectors', '_csv', 'curses', 'getopt', 'atexit', 'traceback', 'platform', 'py_compile', 'faulthandler', 'filecmp', '_operator', '_contextvars', '_uuid', 'heapq', 'mailbox', 'numbers', 'tty', 'unittest', 'zlib', '_symtable', '_posixshmem', 'logging', '_queue', '_sha256', 'tokenize', 'sched', 'code', 'posix', 'pyclbr', 'socket', 'turtledemo', 'ntpath', 'codecs', '_functools', 'cmd', 'msvcrt', 'asyncio', 'signal', '_codecs_iso2022', '_sqlite3', 'termios', 'syslog', '_locale', 'compileall', 'smtplib', 'array', 'socketserver', 'reprlib', '_blake2', 'asyncore', 'bdb', '_bz2', '_codecs_hk', 'bz2', 'ensurepip', 'tabnanny', 'audioop', 'inspect', '_crypt', 'nturl2path', 'csv', 'cProfile', '_markupbase', 'zipimport', 'pydoc_data', '_multibytecodec', 'cmath', 'nis', 'ipaddress', 'fnmatch', '_strptime', '_datetime', '__future__', '_winapi', 'codeop', 'opcode', 'readline', 'shutil', 'urllib', '_curses', 'msilib', 'threading', 'email', '_asyncio', 'winreg', 'types', 're', 'modulefinder', 'optparse', 'copyreg', 'fractions', 'turtle', 'statistics', '_abc', '_msi', 'decimal', 'glob', 'graphlib', 'posixpath', 'gzip', 'smtpd', 'mmap', 'random', 'pprint', '_md5', '_aix_support', '_json', '_compression', '_ssl', 'tempfile', '_bootsubprocess', '_tracemalloc', 'fileinput', '_opcode', 'pty', 'colorsys', '_frozen_importlib', '_tkinter', 'os', 'chunk', 'contextlib', '_compat_pickle', 'getpass', 'sre_compile', 'token', 'venv', 'hashlib', 'typing', 'sndhdr', '_gdbm', 'resource', '_bisect', 'secrets'})"
